...
internal sealed class HotkeyBinding
{
    ...
    private readonly record struct Stroke(bool IsMouse, ushort Scan, bool Extended, uint MouseDown, uint MouseUp, uint MouseData, bool Pulse)
    {
        ...
        private static ushort KeyToVirtualKey(string key)
        {
            ...
            return key switch
            {
                "ESC" or "ESCAPE" => 0x1B, "TAB" => 0x09, "SPACE" => 0x20, "ENTER" => 0x0D,
                "BACKSPACE" => 0x08, "CAPSLOCK" => 0x14, "NUMLOCK" => 0x90, "SCROLLLOCK" => 0x91,
                "INSERT" => 0x2D, "DELETE" => 0x2E, "HOME" => 0x24, "END" => 0x23,
                "PAGEUP" => 0x21, "PAGEDOWN" => 0x22, "UP" => 0x26, "DOWN" => 0x28, "LEFT" => 0x25, "RIGHT" => 0x27,
                "NUMPADDECIMAL" => 0x6E, "NUMPADDIVIDE" => 0x6F, "NUMPADMULTIPLY" => 0x6A,
                "NUMPADMINUS" => 0x6D, "NUMPADPLUS" => 0x6B, "NUMPADENTER" => 0x0D,
                "MINUS" or "-" => 0xBD, "EQUALS" or "=" => 0xBB, "LBRACKET" or "[" => 0xDB,
                "RBRACKET" or "]" => 0xDD, "BACKSLASH" or "\\" => 0xDC, "SEMICOLON" or ";" => 0xBA,
                "APOSTROPHE" or "'" => 0xDE, "COMMA" or "," => 0xBC, "PERIOD" or "." => 0xBE,
                "SLASH" or "/" => 0xBF, "GRAVE" or "`" => 0xC0,
                _ => 0
            };
        }
    }
