...
| 冰霜 | 冷酷严冬 `196770`、冰霜之柱 `51271`、冰龙吐息基础/当前覆盖 `152279`/`1249658`、符文武器增效 `47568`、冰霜巨龙之怒 `279302`、死神印记 `439843`、亡者复生 `46585` |
...
明确意图。冰 DK 因而也保留短冷却群伤冷酷严冬和亡者复生，避免尾怪快死时浪费到
下一波；邪 DK 保持完整大爆发保留，但不擅自把疾病刷新当爆发扣住，因为同一个 M4
也必须能在持续 Boss 机制中正常输出。两系都继续沿用 JustAC 的普通填充优先级。
