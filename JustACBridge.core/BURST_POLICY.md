...
| 冰霜 | 冰霜之柱 `51271`、冰龙吐息基础/当前覆盖 `152279`/`1249658`、符文武器增效 `47568`、冰霜巨龙之怒 `279302`、死神印记 `439843`、亡者复生 `46585` |
...
明确意图。冰 DK 保留亡者复生，但冷酷严冬不是简单爆发黑名单，继续按 JustAC 普通
循环释放；邪 DK 保留其余大爆发，但不擅自把疾病刷新或灵魂收割当作简单 M4 黑名单，
